...
#elif (defined (__ISD9100__) || defined (__N575F145__))
...
)
{
	...
	{
		// because the atemel is based on 256kbytes order, therefore should make it to be 512k 
		u8CapacityOrder -= 1; 
	}
	psSpiFlashHandler->u32FlashSize = (1024*512/8)<<u8CapacityOrder;
}
